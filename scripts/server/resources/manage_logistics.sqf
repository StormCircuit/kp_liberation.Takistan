                ...
                case 3: {
                    if ((_x select 8) > 1) then {
                        ...
                        if (((_x select 4) isEqualTo [0,0,0]) && ((_x select 5) isEqualTo [0,0,0]) && ((_x select 6) isEqualTo [0,0,0])) then {
                            ...
                            //the time being divided is a multiplier that acts as speed. in Meters per Minute (default 800 meters per minute)
                            _time = ceil (((_x select 2) distance2D (_x select 3)) / 1000);
                        };

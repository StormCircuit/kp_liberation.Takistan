//Commented out and replaced with direct arsenal access. Still need to remove the param but this should help for now to
//remove errors when trying to load the arsenal from KP lib menu causing errors
...
//storms comment: basically negating the bottom lines in favor of BI or ACE arsenal
